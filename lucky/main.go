...
var userNames string = "bibibi-bug,dotqi,WithLin,youzizzz,zcmiao190,wbly7758,misasky,qizhenshuai,motanzg,Wooshawn,itstudying,vhuyuy,jokerddj,tianguozhifeng,SHIJIEZ,gumochengxing,dfy167,LyricTian,hades2013,vinnking,wweir,violetgo,Imhven,xskingdeekis,wangyun111,memoryxyd,chplain,willxuecn,yibalaodao,xiang2lin,hacfox,xingliuhua,yrx1354,mfcab,hunterfall,solarhell,thesilent,lhkzx007,171869092,haphupan,921034403,yuzhoutong,baidw,Sakurasan,NightFarmer,imxyb,xiam123,qbmiller,Uncho,LinlinDu,sayhei,lvchengchang,le0l1,1509477745,dcwang1989,swing4,archer-bao,sszgr,83103005,qq976739120,aredcup,sowhaton,royromny,wx7217242,thhy,rongxr,MonkeyInWind,Fang-Li,hbk100,小考拉"
...
func init() {
	...
	fmt.Println(`       → 感谢@聪少 @深圳-track的无私分享 ←      `)
	fmt.Println(`     https://github.com/devfeel/dotweb      `)
	fmt.Println(``)

	fmt.Println(`活动地址: https://github.com/devfeel/dotweb/issues/181`)
